...
var selectedFolder = Folder.selectDialog("Please select folder");
	...
	{
		var fileList = selectedFolder.getFiles(/\.(tga|png|tiff)$/i); 
	}
...
function saveTarga32(doc){
	...
	var destination = File(outputfolder + "/" + sourceName + ".tiff");
	

	tiffSaveOptions = new TiffSaveOptions();
	tiffSaveOptions.alphaChannels = true;
	tiffSaveOptions.imageCompression=TIFFEncoding.TIFFLZW;
	//tiffSaveOptions.resolution = TargaBitsPerPixels.THIRTYTWO;
	doc.channels.getByName("Alpha 2").remove();
	doc.saveAs(destination, tiffSaveOptions, true, Extension.LOWERCASE);
